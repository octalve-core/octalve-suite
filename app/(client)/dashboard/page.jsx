                    ...
                    <Card className="h-full bg-gradient-to-br from-slate-900 to-slate-800 text-white border-0">
                        <CardContent className="p-6 flex flex-col h-full">
                            ...
                            <p className="text-lg font-semibold flex-1">
                                {approvals.length > 0
                                    ? `Review and approve ${currentPhase?.name || "pending phase"
                                    }`
                            ...
                            <div className="space-y-3">
                                {sortedPhases.slice(0, 5).map((phase, index) => {
                                    ...
                                    return (
                                        <div
                                            key={phase.id}
                                            className={`flex items-center gap-4 p-3 rounded-xl transition-colors ${isLocked
                                                    ? "opacity-50 cursor-not-allowed"
                                                    : "hover:bg-slate-50 cursor-pointer"
                                                }`}
                                            onClick={() =>
                                                !isLocked && router.push(`/phases/${phase.id}`)
                                            }
                                        >
                                            <div
