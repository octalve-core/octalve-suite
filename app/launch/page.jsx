                        ...
                        <div className="grid items-center gap-12 lg:grid-cols-2">
                            <div className="max-w-xl">
                                <h1 className="text-4xl font-extrabold tracking-tight text-slate-900 sm:text-5xl">
                                    ...
                                    <span className="text-[#E61525]"> Launch</span>
                            ...
                            <div className="lg:justify-self-end">
                                <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#FFF1C7] via-white to-[#FFF6D9] p-6 shadow-2xl">
                                    <div className="relative origin-center rounded-2xl bg-white shadow-lg ring-1 ring-black/5">
                                        ...
                                        <Image src="/brand/OctalveSuite0.png" alt="Product screenshot" width={600} height={400} className="w-full h-auto rounded-b-2xl object-cover" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <section className="bg-white">
                    <div className="mx-auto max-w-6xl px-5 py-14 lg:py-24">
                        ...
                        <div className="relative mt-12 sm:mt-14">
                            <div className="absolute left-5 top-0 bottom-0 w-px bg-[#E61525] lg:left-1/2 lg:-translate-x-1/2"></div>

                            <div className="space-y-14 lg:space-y-20">
                                {/* Step 1 */}
                                <div className="relative pl-12 lg:grid lg:grid-cols-[1fr_140px_1fr] lg:items-start lg:gap-10 lg:pl-0">
                                    <div className="absolute left-5 top-6 z-10 grid h-10 w-10 -translate-x-1/2 place-items-center rounded-xl border border-[#E61525] bg-white lg:left-1/2 lg:top-10">
                                        <span className="h-3 w-3 rounded bg-[#E61525]"></span>
                                    </div>
                                    <div className="lg:pr-6 lg:text-right">
                                        <span className="inline-flex rounded-md bg-red-100 px-3 py-1 text-xs font-semibold text-slate-900">Phase 1</span>
                                        <h3 className="mt-4 text-lg font-extrabold text-slate-900 sm:text-xl">Discovery & Strategy</h3>
                                    </div>
                                    <div className="hidden lg:block"></div>
                                    <div className="lg:pl-6">
                                        <div className="rounded-3xl bg-[#E61525]/10 p-6 shadow-sm ring-1 ring-black/5">
                                            <p className="text-sm leading-relaxed text-slate-700">Align the vision, offer, and launch plan</p>
                                        </div>
                                    </div>
                                </div>
                                {/* More steps can be added here if needed, but keeping it simple for now based on the HTML */}
                            </div>
                        </div>
                    </div>
                </section>
